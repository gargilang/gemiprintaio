...
-- Baseline checkpoint — 2026-07-03
-- Single source of truth, regenerated from cloud Singapore via `supabase migration squash`.
-- Collapses migrations 2026-06-15 .. 2026-07-03 (Produk Jual, BOM dimensi, dll).
...
CREATE OR REPLACE FUNCTION "public"."bulk_update_keuangan"("updates" "jsonb") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  rec jsonb;
...
ALTER FUNCTION "public"."bulk_update_keuangan"("updates" "jsonb") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."barang" (
    ...
    "muncul_di_pos_status" integer DEFAULT 1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."barang_komponen" (
    "id" "text" NOT NULL,
    ...
    "client_mutation_id" "text",
    "jumlah_roll" integer,
    "panjang" numeric(10,4),
    "lebar" numeric(10,4),
    CONSTRAINT "barang_komponen_qty_check" CHECK (("qty" > (0)::numeric)),
    CONSTRAINT "bk_no_self_ref" CHECK (("parent_barang_id" <> "komponen_id"))
);


ALTER TABLE "public"."barang_komponen" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."laporan_bulanan" (
    ...
    "deleted_at" timestamp with time zone,
    "client_mutation_id" "text",
    CONSTRAINT "laporan_bulanan_sync_status_check" CHECK (("sync_status" = ANY (ARRAY['pending'::"text", 'synced'::"text", 'conflict'::"text"])))
);


ALTER TABLE "public"."laporan_bulanan" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."pinjaman_karyawan" (
    ...
    "deleted_at" timestamp with time zone,
    "client_mutation_id" "text",
    CONSTRAINT "pinjaman_karyawan_jenis_check" CHECK (("jenis" = ANY (ARRAY['TARIK'::"text", 'POTONG_GAJI'::"text", 'BAYAR_TUNAI'::"text", 'POTONG_BAGI_HASIL'::"text"]))),
...
ALTER TABLE ONLY "public"."barang_komponen"
    ADD CONSTRAINT "barang_komponen_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."laporan_bulanan"
    ADD CONSTRAINT "laporan_bulanan_nomor_laporan_key" UNIQUE ("nomor_laporan");



ALTER TABLE ONLY "public"."laporan_bulanan"
    ADD CONSTRAINT "laporan_bulanan_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_barang_komponen_deleted" ON "public"."barang_komponen" USING "btree" ("is_deleted");



CREATE INDEX "idx_barang_komponen_komponen" ON "public"."barang_komponen" USING "btree" ("komponen_id");



CREATE INDEX "idx_barang_komponen_parent" ON "public"."barang_komponen" USING "btree" ("parent_barang_id");



CREATE INDEX "idx_barang_komponen_sync" ON "public"."barang_komponen" USING "btree" ("sync_status");
...
CREATE INDEX "idx_keuangan_periode_id" ON "public"."keuangan" USING "btree" ("periode_id");
...
CREATE INDEX "idx_laporan_bulanan_period" ON "public"."laporan_bulanan" USING "btree" ("accounting_period_id");



CREATE INDEX "idx_laporan_bulanan_sync" ON "public"."laporan_bulanan" USING "btree" ("sync_status");
...
ALTER TABLE ONLY "public"."barang_komponen"
    ADD CONSTRAINT "barang_komponen_komponen_id_fkey" FOREIGN KEY ("komponen_id") REFERENCES "public"."barang"("id");



ALTER TABLE ONLY "public"."barang_komponen"
    ADD CONSTRAINT "barang_komponen_parent_barang_id_fkey" FOREIGN KEY ("parent_barang_id") REFERENCES "public"."barang"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."keuangan"
    ADD CONSTRAINT "keuangan_periode_id_fkey" FOREIGN KEY ("periode_id") REFERENCES "public"."accounting_periods"("id");
...
ALTER TABLE ONLY "public"."laporan_bulanan"
    ADD CONSTRAINT "laporan_bulanan_accounting_period_id_fkey" FOREIGN KEY ("accounting_period_id") REFERENCES "public"."accounting_periods"("id");
...
ALTER TABLE ONLY "public"."stock_opname_items"
    ADD CONSTRAINT "stock_opname_items_roll_variant_id_fkey" FOREIGN KEY ("roll_variant_id") REFERENCES "public"."barang_roll_variants"("id");
...
GRANT ALL ON FUNCTION "public"."bulk_update_keuangan"("updates" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."bulk_update_keuangan"("updates" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."bulk_update_keuangan"("updates" "jsonb") TO "service_role";
...
GRANT ALL ON TABLE "public"."barang_komponen" TO "anon";
GRANT ALL ON TABLE "public"."barang_komponen" TO "authenticated";
GRANT ALL ON TABLE "public"."barang_komponen" TO "service_role";
...
GRANT ALL ON TABLE "public"."laporan_bulanan" TO "anon";
GRANT ALL ON TABLE "public"."laporan_bulanan" TO "authenticated";
GRANT ALL ON TABLE "public"."laporan_bulanan" TO "service_role";
