...
--
-- Usage (Supabase CLI, after `supabase link`):
--   npx supabase db push
-- If this schema was already applied earlier (SQL Editor / npm run supabase:apply), mark baseline applied once:
--   npx supabase migration repair 20260425120000 --status applied
-- Legacy without CLI: still use supabase/schema.sql + npm run supabase:apply.
--
