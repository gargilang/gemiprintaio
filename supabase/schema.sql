...
CREATE TABLE IF NOT EXISTS barang_roll_variants (
  ...
  panjang_tersedia_m DOUBLE PRECISION NOT NULL DEFAULT 0,
  average_cost_per_m2 DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS inventory_movements (
  ...
  value_delta DOUBLE PRECISION NOT NULL DEFAULT 0,
  qty_before DOUBLE PRECISION NOT NULL DEFAULT 0,
  qty_after DOUBLE PRECISION NOT NULL DEFAULT 0,
  avg_cost_before DOUBLE PRECISION NOT NULL DEFAULT 0,
  avg_cost_after DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS pengaturan_toko (
  ...
  ppn_persen_default DOUBLE PRECISION NOT NULL DEFAULT 11,
...
CREATE TABLE IF NOT EXISTS penjualan (
  ...
  ppn_persen DOUBLE PRECISION NOT NULL DEFAULT 0,
  ppn_metode TEXT NOT NULL DEFAULT 'EKSKLUSIF' CHECK(ppn_metode IN ('EKSKLUSIF', 'INKLUSIF')),
  dpp_total DOUBLE PRECISION NOT NULL DEFAULT 0,
  ppn_total DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS item_penjualan (
  ...
  dpp_satuan DOUBLE PRECISION NOT NULL DEFAULT 0,
  ppn_satuan DOUBLE PRECISION NOT NULL DEFAULT 0,
  dpp_total DOUBLE PRECISION NOT NULL DEFAULT 0,
  ppn_total DOUBLE PRECISION NOT NULL DEFAULT 0,
  dibuat_pada TIMESTAMPTZ DEFAULT NOW(),
  sync_status TEXT DEFAULT 'pending' CHECK(sync_status IN ('pending', 'synced', 'conflict')),
...
CREATE TABLE IF NOT EXISTS penawaran (
  ...
  total_jumlah DOUBLE PRECISION NOT NULL DEFAULT 0,
  kena_ppn INTEGER NOT NULL DEFAULT 0,
  ppn_persen DOUBLE PRECISION NOT NULL DEFAULT 0,
  ppn_metode TEXT NOT NULL DEFAULT 'EKSKLUSIF' CHECK(ppn_metode IN ('EKSKLUSIF', 'INKLUSIF')),
  dpp_total DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS item_penawaran (
  ...
  jumlah DOUBLE PRECISION NOT NULL,
  nama_satuan TEXT NOT NULL,
  faktor_konversi DOUBLE PRECISION NOT NULL DEFAULT 1,
  harga_satuan DOUBLE PRECISION NOT NULL,
  subtotal DOUBLE PRECISION NOT NULL,
  panjang DOUBLE PRECISION,
  lebar DOUBLE PRECISION,
...
CREATE TABLE IF NOT EXISTS retur_penjualan (
  ...
  total_retur DOUBLE PRECISION NOT NULL DEFAULT 0,
  dpp_total DOUBLE PRECISION NOT NULL DEFAULT 0,
  ppn_total DOUBLE PRECISION NOT NULL DEFAULT 0,
  total_hpp DOUBLE PRECISION NOT NULL DEFAULT 0,
  receivable_reduction DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS item_retur_penjualan (
  ...
  harga_satuan DOUBLE PRECISION NOT NULL,
  subtotal DOUBLE PRECISION NOT NULL,
  hpp_satuan DOUBLE PRECISION NOT NULL DEFAULT 0,
  hpp_total DOUBLE PRECISION NOT NULL DEFAULT 0,
  dpp_total DOUBLE PRECISION NOT NULL DEFAULT 0,
  ppn_total DOUBLE PRECISION NOT NULL DEFAULT 0,
  movement_id TEXT,
  dibuat_pada TIMESTAMPTZ DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS retur_pembelian (
  ...
  dpp_total DOUBLE PRECISION NOT NULL DEFAULT 0,
  ppn_total DOUBLE PRECISION NOT NULL DEFAULT 0,
  debt_reduction DOUBLE PRECISION NOT NULL DEFAULT 0,
  refund_amount DOUBLE PRECISION NOT NULL DEFAULT 0,
  reason TEXT NOT NULL,
  catatan TEXT,
  dibuat_oleh TEXT,
...
CREATE TABLE IF NOT EXISTS stock_opnames (
  ...
  total_delta_qty DOUBLE PRECISION NOT NULL DEFAULT 0,
  total_delta_value DOUBLE PRECISION NOT NULL DEFAULT 0,
  dibuat_pada TIMESTAMPTZ DEFAULT NOW(),
  diperbarui_pada TIMESTAMPTZ DEFAULT NOW(),
  sync_status TEXT DEFAULT 'pending' CHECK(sync_status IN ('pending', 'synced', 'conflict')),
  last_synced_at TIMESTAMPTZ,
...
CREATE TABLE IF NOT EXISTS stock_opname_items (
  ...
  delta_qty DOUBLE PRECISION NOT NULL DEFAULT 0,
  unit_cost DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS production_material_consumptions (
  ...
  billed_area_m2 DOUBLE PRECISION NOT NULL DEFAULT 0,
  waste_area_m2 DOUBLE PRECISION NOT NULL DEFAULT 0,
  movement_id TEXT,
