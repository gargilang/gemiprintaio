...
export default function ModalTambahFinishing({
  onClose,
  onAdd,
  existingFinishing = [],
  itemName,
      ...
      >
          ...
          <div className="space-y-4 mb-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border-2 border-gray-200 dark:border-slate-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-700 focus:border-amber-700 dark:bg-slate-800 dark:text-slate-100"
              />
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                {finishingList.map((fin, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between bg-amber-50 dark:bg-slate-800 px-4 py-3 rounded-lg border border-amber-200 dark:border-amber-800/50"
                  >
                    <div>
                    ...
                    <button
                      ...
                      className="text-red-600 hover:bg-red-100 dark:bg-red-900/30 p-2 rounded-lg transition-colors"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="none"
        ...
        <div className="p-4 border-t border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-800 flex items-center justify-end gap-3 shrink-0">
          <button
            type="button"
            onClick={onClose}
            className="px-6 py-2 bg-white dark:bg-slate-900 border-2 border-gray-300 dark:border-slate-600 text-gray-700 dark:text-slate-300 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors font-semibold"
          >
            Batal
          </button>
          <button
