    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl shadow-lg p-6 text-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold uppercase tracking-wide">Stock Adjustment</h2>
              <p className="text-white/90 text-sm">Adjustment manual, koreksi, dan waste dengan ledger audit.</p>
            </div>
          </div>
      ...
      <section className="grid gap-4 lg:grid-cols-[420px_1fr]">
        <div className="rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
          <h2 className="mb-3 text-base font-semibold text-slate-800 dark:text-slate-100">Input Adjustment</h2>
