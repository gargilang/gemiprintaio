...
// dim=1 → butuh_dimensi_status=1, satuan_dasar="m²", stok reset ke 0 (diisi ulang via pembelian)
// dim=0 → butuh_dimensi_status=0, satuan_dasar=u (satuan asli)
const BARANG_TEMPLATES = [
  // Media Cetak — semua roll/meter → dim=1, stok dalam m²
  { k: "cat-media-cetak", s: "sub-mc-flexi", u: "m²", n: "Flexi 280gr Frontlit", sp: "280gr", stok: 0, min: 10, dim: 1, buy: 18000, sell: 25000, mem: 22000 },
  { k: "cat-media-cetak", s: "sub-mc-flexi", u: "m²", n: "Flexi 440gr Backlit", sp: "440gr", stok: 0, min: 8, dim: 1, buy: 32000, sell: 45000, mem: 40000 },
  { k: "cat-media-cetak", s: "sub-mc-flexi", u: "m²", n: "Flexi 280gr Roll 3.2m", sp: "3.2m", stok: 0, min: 2, dim: 1, buy: 550000, sell: 720000, mem: 680000 },
  { k: "cat-media-cetak", s: "sub-mc-flexi", u: "m²", n: "Flexi Korea 510gr", sp: "510gr", stok: 0, min: 5, dim: 1, buy: 42000, sell: 58000, mem: 52000 },
  { k: "cat-media-cetak", s: "sub-mc-flexi", u: "m²", n: "Banner Korea 13oz", sp: "13oz", stok: 0, min: 10, dim: 1, buy: 22000, sell: 32000, mem: 29000 },
  { k: "cat-media-cetak", s: "sub-mc-vinyl", u: "m²", n: "Vinyl Glossy Stiker", sp: "Glossy", stok: 0, min: 20, dim: 1, buy: 12000, sell: 18000, mem: 16000 },
  { k: "cat-media-cetak", s: "sub-mc-vinyl", u: "m²", n: "Vinyl Doff Stiker", sp: "Doff", stok: 0, min: 15, dim: 1, buy: 13000, sell: 19000, mem: 17000 },
  { k: "cat-media-cetak", s: "sub-mc-vinyl", u: "m²", n: "Vinyl Transparan Roll 1.27m", sp: "1.27m", stok: 0, min: 1, dim: 1, buy: 380000, sell: 520000, mem: 480000 },
  { k: "cat-media-cetak", s: "sub-mc-vinyl", u: "m²", n: "Vinyl Reflective Grade", sp: "Reflective", stok: 0, min: 5, dim: 1, buy: 45000, sell: 65000, mem: 58000 },
  { k: "cat-media-cetak", s: "sub-mc-vinyl", u: "m²", n: "Vinyl Floor Graphic", sp: "Floor", stok: 0, min: 5, dim: 1, buy: 38000, sell: 55000, mem: 50000 },
  ...
  { k: "cat-media-cetak", s: "sub-mc-backlit", u: "m²", n: "Backlit Film 200mic", sp: "200mic", stok: 0, min: 5, dim: 1, buy: 35000, sell: 48000, mem: 44000 },
  { k: "cat-media-cetak", s: "sub-mc-owv", u: "m²", n: "One Way Vision 1.37m", sp: "1.37m", stok: 0, min: 7, dim: 1, buy: 28000, sell: 40000, mem: 36000 },
  { k: "cat-media-cetak", s: "sub-mc-albatross", u: "m²", n: "Albatross 270gr", sp: "270gr", stok: 0, min: 5, dim: 1, buy: 24000, sell: 35000, mem: 32000 },
  { k: "cat-media-cetak", s: "sub-mc-canvas", u: "m²", n: "Canvas Matte 380gr", sp: "380gr", stok: 0, min: 3, dim: 1, buy: 55000, sell: 78000, mem: 72000 },
  ...
  { k: "cat-substrat-uv", s: "sub-uv-akrilik", u: "lembar", n: "Akrilik Clear 3mm A3", sp: "3mm A3", stok: 20, min: 3, dim: 0, buy: 85000, sell: 135000, mem: 125000 },
  { k: "cat-substrat-uv", s: "sub-uv-kayu", u: "lembar", n: "Kayu Jati 5mm A4", sp: "5mm A4", stok: 15, min: 2, dim: 0, buy: 45000, sell: 78000, mem: 72000 },
  { k: "cat-substrat-uv", s: "sub-uv-mdf", u: "lembar", n: "MDF 3mm 60x40cm", sp: "60x40", stok: 30, min: 5, dim: 0, buy: 25000, sell: 45000, mem: 42000 },
  { k: "cat-substrat-uv", s: "sub-uv-aluminium", u: "lembar", n: "Aluminium Composite 3mm", sp: "3mm", stok: 25, min: 3, dim: 0, buy: 120000, sell: 185000, mem: 170000 },
  { k: "cat-substrat-uv", s: "sub-uv-kaca", u: "lembar", n: "Kaca Tempered 5mm A4", sp: "5mm A4", stok: 8, min: 1, dim: 0, buy: 35000, sell: 65000, mem: 60000 },
  ...
  { k: "cat-finishing", s: "sub-fn-lam-glossy", u: "m²", n: "Laminating Glossy 1.27m", sp: "1.27m", stok: 0, min: 5, dim: 1, buy: 8000, sell: 14000, mem: 12500 },
  { k: "cat-finishing", s: "sub-fn-lam-doff", u: "m²", n: "Laminating Doff 1.27m", sp: "1.27m", stok: 0, min: 5, dim: 1, buy: 8500, sell: 14500, mem: 13000 },
  { k: "cat-finishing", s: "sub-fn-foam", u: "lembar", n: "Foam Board 5mm 60x90", sp: "5mm", stok: 100, min: 10, dim: 0, buy: 18000, sell: 32000, mem: 29000 },
  { k: "cat-finishing", s: "sub-fn-kaca", u: "lembar", n: "Kaca Acrylic 3mm A3", sp: "3mm A3", stok: 35, min: 5, dim: 0, buy: 55000, sell: 88000, mem: 80000 },
  ...
  { k: "cat-media-cetak", s: "sub-mc-flexi", u: "m²", n: "Flexi Black Back 440gr", sp: "440gr BB", stok: 0, min: 4, dim: 1, buy: 38000, sell: 52000, mem: 48000 },
  ...
  { k: "cat-substrat-uv", s: "sub-uv-plastik", u: "lembar", n: "PVC Foam Board 10mm", sp: "10mm", stok: 18, min: 2, dim: 0, buy: 95000, sell: 155000, mem: 142000 },
  ...
  { k: "cat-media-cetak", s: "sub-mc-vinyl", u: "m²", n: "Vinyl Sandblast", sp: "Sandblast", stok: 0, min: 3, dim: 1, buy: 22000, sell: 33000, mem: 30000 },
  ...
  { k: "cat-finishing", s: "sub-fn-lam-sandblast", u: "m²", n: "Laminating Sandblast 1.37m", sp: "1.37m", stok: 0, min: 3, dim: 1, buy: 9500, sell: 16000, mem: 14500 },
  { k: "cat-media-cetak", s: "sub-mc-lainlain", u: "m²", n: "Mesh Banner 270gr", sp: "270gr", stok: 0, min: 5, dim: 1, buy: 19000, sell: 28000, mem: 25500 },
  ...
  { k: "cat-substrat-uv", s: "sub-uv-metal", u: "lembar", n: "Plat Aluminium Brushed A4", sp: "A4", stok: 12, min: 2, dim: 0, buy: 65000, sell: 110000, mem: 100000 },
  ...
  { k: "cat-media-cetak", s: "sub-mc-backlit", u: "m²", n: "Backlit Super Bright", sp: "Super", stok: 0, min: 2, dim: 1, buy: 48000, sell: 68000, mem: 62000 },
...
function buildPayload() {
  ...
  for (let i = 0; i < BARANG_TEMPLATES.length; i++) {
    ...
    // Dimensional materials always use m² as base unit and start at 0 stock.
    // Stock is built up via purchases that record panjang × lebar.
    const satuanDasar = t.dim === 1 ? "m²" : t.u;
    const stokAwal = t.dim === 1 ? 0 : t.stok;
    const minStok = t.dim === 1 ? 0 : t.min;
    const namaSatuan = t.dim === 1 ? "m²" : t.u;
